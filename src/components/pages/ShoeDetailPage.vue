<template>
  <v-container class="w-75 fill-height overflow-auto align-start pa-10">
    <div class="d-flex w-100 align-center mt-16">
      ...
      <div class="d-flex align-center">
        ...
        <v-icon size="large" icon="mdi-cart mr-2" />
      </div>
    </div>
    <v-row class="h-75">
      <v-col cols="6" class="pa-4">
        <ShoeImagePreview :image="ShoeImage" :logo="ShoeLogo" />
      </v-col>
      <v-col cols="6">
        <ShoeDetails
...
import ShoeLogo from "../../assets/nike-logo.png";
